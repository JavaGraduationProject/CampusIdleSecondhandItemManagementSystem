            ...
            <div class="nav-wrapper search-bar">
                <form ng-submit="search()" class="ng-pristine ng-invalid ng-invalid-required" action="">
                    <div class="input-field">
                        <input id="search" name="str" value="<c:out value="${search}"></c:out>" placeholder="" style="height: 35px;"
                               class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required"/>
                        <input type="submit" class="btn"value="搜索" style="background: rgb(25, 162, 230);color: #8b1014"></input>
...
<!--
    ...
    描述：左侧导航条
-->
<div style="margin-top: 20px;font-size: 30px;font-family: 楷体;color: #0f0f0f;text-align: center;">
...
<div class="main-content">
    ...
    <div  style="width: 1650px;text-align: center;font-family: 楷体;font-size: 30px;">
        <c:if test="${empty catelog.name}"><a href="">最新发布</a></c:if>
         <c:if test="${!empty catelog.name}"><a href="">${catelog.name}</a></c:if>
        <hr class="hr1">
        <hr class="hr2">
    </div>
    <div class="waterfoo stark-components row" style="width: 1650px;text-align: center;">
