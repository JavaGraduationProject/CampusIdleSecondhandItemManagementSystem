            ...
            <div class="nav-wrapper search-bar">
                <form class="ng-pristine ng-invalid ng-invalid-required" action="<%=basePath%>goods/search">
                    <div class="input-field">
                        <input id="search" name="str" placeholder="" style="height: 40px;"
                               class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required"/>
                      	<input type="submit" class="btn"value="搜索" style="color: #8b1014"></input>
...
<div class="main-content">
    ...
    <div class="waterfoo stark-components row" style="width: 1650px;margin-left: 0px; ">
